...
const c: IConfig = {
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'http://www.lubibox.com',

  // 网站标题
  title: '撸币盒子 - 币圈精选项目指南',

  // 网站描述
  description: '撸币盒子 - 币圈精选项目指南',

  // 网站关键字
  keywords: '撸币盒子,撸币,币圈,币圈导航,撸币指南,币圈指南,虚拟币导航,虚拟币项目,最新山寨币',
  ...
  footerContent: `
    ...
    <div>Copyright © 2019-2021 lubibox.com, All Rights Reserved</div>
  `,

  // 百度统计地址
  // https://tongji.baidu.com/web/welcome/login
  baiduStatisticsUrl: 'https://hm.baidu.com/hm.js?6e667a30ffa01d3f9d46c59ad1e2ec0f',
  ...
  simThemeConfig: {
    ...
    description: '这里收录多达 <b>${total}</b> 个优质币圈项目网站， 助您赢在币圈'
  }
}
